...
class MailCollector extends CommonDBTM
{
    ...
    public function getHeaders(Message $message)
    {
        ...
        //IVC 22.12.25
        if($rawHeaderFrom = $message->getHeader('from')) {
            $address = $rawHeaderFrom instanceof AbstractAddressList ? $rawHeaderFrom->getAddressList()->rewind() : null;
            $name = $address instanceof Address ? $address->getName() : null;
            $mail_details["from_email_name"] = $name != null ? $name : '';
        }
        //
